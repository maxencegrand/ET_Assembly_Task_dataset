...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        ...
        liste_zone = [
            "\\multirow{5}{*}{Régulières Contiguë 4}",
        ...
        with open("mon_tableau_grasp.tex", "w") as fichier:
            ...
            fichier.write("\\hline\n")
            fichier.write(
                "Surface & Feature & \\multicolumn{5}{c|}{\\textbf{Modele}} & \\multicolumn{5}{c|}{\\textbf{Machine Learning}}\\\\\n"
            )
            fichier.write("\\hline\n")
            fichier.write(
                "& & t-3 & t-2 & t-1 & t-0.5 & t & t-3 & t-2 & t-1 & t-0.5 & t\\\\\n"
            )
            fichier.write("\\hline\n")
            for indice_zone, zone_predi in enumerate(
                [
                    [
                        [area4_grasp_strong, nb_area4_grasp_strong],
                        [ML_area4_grasp_strong, ML_nb_area4_grasp_strong],
                    ],
                    [
                        [area8_grasp_strong, nb_area8_grasp_strong],
                        [ML_area8_grasp_strong, ML_nb_area8_grasp_strong],
                    ],
                    [
                        [sliding_area4_grasp_strong, nb_sliding_area4_grasp_strong],
                        [
                            ML_sliding_area4_grasp_strong,
                            ML_nb_sliding_area4_grasp_strong,
                        ],
                    ],
                    [
                        [sliding_area8_grasp_strong, nb_sliding_area8_grasp_strong],
                        [
                            ML_sliding_area8_grasp_strong,
                            ML_nb_sliding_area8_grasp_strong,
                        ],
                    ],
                    [
                        [semantic_grasp_0, nb_semantic_grasp_0],
                        [ML_semantic_grasp_0, ML_nb_semantic_grasp_0],
                    ],
                    [
                        [semantic_grasp_1b, nb_semantic_grasp_1b],
                        [ML_semantic_grasp_1b, ML_nb_semantic_grasp_1b],
                    ],
                    [
                        [semantic_grasp_1, nb_semantic_grasp_1],
                        [ML_semantic_grasp_1, ML_nb_semantic_grasp_1],
                    ],
                    [
                        [semantic_grasp_2, nb_semantic_grasp_2],
                        [ML_semantic_grasp_2, ML_nb_semantic_grasp_2],
                    ],
                    [
                        [block_grasp, nb_block_grasp],
                        [ML_block_grasp, ML_nb_block_grasp],
                    ],
                ]
            ):
                    ...
                    for nb_good_zone_predi, nb_zone_predi in zone_predi:
                        for timestamp in [0, 1000, 2000, 2500, 3000]:
                            fichier.write(
                                ...
                                + "{:.1f}".format(
                                    100
                                    * nb_good_zone_predi[0][f][timestamp]
                                    / nb_zone_predi[0][timestamp]
                                )
                            )
                    fichier.write("\\\\ \n")
                fichier.write("\\hline\n")
        ...
        with open("mon_tableau_release.tex", "w") as fichier:
            ...
            for indice_zone, zone_predi in enumerate(
                [
                    [
                        [area4_release_strong, nb_area4_release_strong],
                        [ML_area4_release_strong, ML_nb_area4_release_strong],
                    ],
                    [
                        [area8_release_strong, nb_area8_release_strong],
                        [ML_area8_release_strong, ML_nb_area8_release_strong],
                    ],
                    [
                        [sliding_area4_release_strong, nb_sliding_area4_release_strong],
                        [
                            ML_sliding_area4_release_strong,
                            ML_nb_sliding_area4_release_strong,
                        ],
                    ],
                    [
                        [sliding_area8_release_strong, nb_sliding_area8_release_strong],
                        [
                            ML_sliding_area8_release_strong,
                            ML_nb_sliding_area8_release_strong,
                        ],
                    ],
                    [
                        [semantic_release_0, nb_semantic_release_0],
                        [ML_semantic_release_0, ML_nb_semantic_release_0],
                    ],
                    [
                        [semantic_release_1b, nb_semantic_release_1b],
                        [ML_semantic_release_1b, ML_nb_semantic_release_1b],
                    ],
                    [
                        [semantic_release_1, nb_semantic_release_1],
                        [ML_semantic_release_1, ML_nb_semantic_release_1],
                    ],
                    [
                        [semantic_release_2, nb_semantic_release_2],
                        [ML_semantic_release_2, ML_nb_semantic_release_2],
                    ],
                    [
                        [block_release, nb_block_release],
                        [ML_block_release, ML_nb_block_release],
                    ],
                ]
            ):
                fichier.write(liste_zone[indice_zone])
