...
"""
bestAreaMax renvoi l'emplacement de la meilleur surface chevauchante 4x4 et 8x8
...
# Renvoie la meilleur surface pour les surface semantique level 0
...
# Renvoie la meilleur surface pour les surface semantique level 2
...
# Renvoie la meilleur surface pour les surface semantique level 3
...
fig: correspont à l'assemblage en cours
...
def interpretation(probability, timestamp_indice, world, fig):
    ...
    for r in range(24):
        ...
        for tendon in liste_resultat[max(0, timestamp_indice - 2)][r]:
            proba[0, timestamp_indice % 2, r] += probability[
                0, (timestamp_indice) % 2, tendon
            ]
            proba[1, timestamp_indice % 2, r] += probability[
                1, (timestamp_indice) % 2, tendon
            ]
            proba[2, timestamp_indice % 2, r] += probability[
                2, (timestamp_indice) % 2, tendon
            ]
            proba[3, timestamp_indice % 2, r] += probability[
                3, (timestamp_indice) % 2, tendon
            ]
            proba[4, timestamp_indice % 2, r] += probability[
                4, (timestamp_indice) % 2, tendon
            ]

        # On regarde l'etat precedent pour voir l'evolution post event
        for tendon in liste_resultat[max(0, timestamp_indice - 1)][r]:
            proba[0, (timestamp_indice - 1) % 2, r] += probability[
                0, (timestamp_indice - 1) % 2, tendon
            ]
            proba[1, (timestamp_indice - 1) % 2, r] += probability[
                1, (timestamp_indice - 1) % 2, tendon
            ]
            proba[2, (timestamp_indice - 1) % 2, r] += probability[
                2, (timestamp_indice - 1) % 2, tendon
            ]
            proba[3, (timestamp_indice - 1) % 2, r] += probability[
                3, (timestamp_indice - 1) % 2, tendon
            ]
            proba[4, (timestamp_indice - 1) % 2, r] += probability[
                4, (timestamp_indice - 1) % 2, tendon
            ]
